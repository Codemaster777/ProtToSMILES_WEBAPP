...
HF_MODEL_REPO = "Bhanushray/protein-smiles-model"
...
# Environment Variables for Bio-Embeddings
...
try:
    model_path = hf_hub_download(repo_id=HF_MODEL_REPO, filename=MODEL_FILENAME, cache_dir=bio_model_dir)
